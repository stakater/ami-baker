...
mkdir -p /opt/packer
pushd /opt/packer
wget -nc -q https://releases.hashicorp.com/packer/0.10.1/packer_0.10.1_linux_amd64.zip
unzip -q packer_0.10.1_linux_amd64.zip
popd
mkdir -p /etc/profile.d
echo PATH=$PATH:/opt/packer > /etc/profile.d/packer.sh
